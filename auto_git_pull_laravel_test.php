...
$savePath = "/www/var/laravel-test/";
$gitPath  = "https://git@github.com:wang10086/laravel-test.git";//代码仓库
$email = "1021056947@qq.com";//用户仓库邮箱
$name  = "1021056947@qq.com";//仓库用户名,一般和邮箱一致即可
